...
export const metadata: Metadata = {
  ...
  description: "Browse our comprehensive collection of NPTEL courses with practice questions, quizzes, and interactive learning resources. Prepare for your NPTEL exams with our practice platform.",
  keywords: [
    "NPTEL courses",
  ...
  openGraph: {
    ...
    description: "Browse all available NPTEL courses with practice questions and quizzes to prepare for your exams.",
    type: "website",
